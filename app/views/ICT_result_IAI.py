...
class ProgramCompDetail(Resource):
    def get(self, headers=None):
        ...
        query = '''select component,count(*) as totalfail,round(cpk,2) as cpk from ICT_Project_Test_Realtime.program_fail where '''
...
class ProgramCompDetailLineGraph(Resource):
    def get(self, headers=None):
        ...
        (nominal*500000000) as nominal ,(measured*500000000) as measured from ICT_Project_Test_Realtime.program_fail where component='{0}' '''.format(component)
        ...
        query=''' select case when test_type='boundary scan' then 'digital_bscan'
                ...
                (
                    ...
                    (
                        ...
                        from ICT_Project_Test_Realtime.program_fail
                        where program_id='{0}' and board='{1}' and end_time>='{2}'  
                        and flag=1 and test_type in ('digital','boundary scan','analog powered','powercheck','analog')
                        group by component,fail_state
                    ) a group by fail_state,test_type
                    ...
                    select count(a.component) as fail_number,test_type,fail_state from  
                    (
                        select concat(component,'/',pins) as component,fail_state,test_type from ICT_Project_Test_Realtime.program_fail
                        where program_id='{0}' and board='{1}' and end_time>='{2}'  
                        and flag=1 and test_type = 'testjet'
                        group by component,pins,fail_state
                    ) a group by fail_state,test_type
                    ...
                    select count(a.component) as fail_number,test_type,fail_state from  
                    (
                        select BRC as component,fail_state,test_type,update_time_op from ICT_Project_Test_Realtime.program_fail
                        where program_id='{0}' and board='{1}' and end_time>='{2}'  
                        and flag=1 and test_type in ('open','short')
                        group by BRC,fail_state
                    ) a group by fail_state,test_type
    ...
    def get(self,headers=None):
        ...
        try:
            ...
            query=''' select BRC,test_type,fail_state,program_id,b.solution as solution1,c.solution as solution2,
                      d.solution as solution3,a.solution_memo,max(a.update_time_op) as update_time_op,a.update_op,count(BRC) as failcount
                      from ICT_Project_Test_Realtime.program_fail a
                      left join ICT_Project_Test_Realtime.fail_solution b on a.solution_1=b.id 
                      left join ICT_Project_Test_Realtime.fail_solution c on a.solution_2=c.id 
                      left join ICT_Project_Test_Realtime.fail_solution d on a.solution_3=d.id 
...
class ProgCaseTestjet(Resource):
    def get(self,headers=None):
        ...
        try:
            ...
            # 取得每個component/pins最新closed時間
            query=''' select concat(component,'/',pins) as component,max(update_time_op) as update_time from ICT_Project_Test_Realtime.program_fail
            ...
            query=''' select count(component) as failcount,component from
                      (
                        select concat(component,'/',pins) as component from ICT_Project_Test_Realtime.program_fail
                        where  program_id='{0}' and board='{1}' and flag=1 and end_time>='{2}'  
                        and fail_state between 0 and 1  and test_type='testjet'
                      ) a
            ...
            query=''' select count(component) as reopencount,component from
                     (
                        select concat(component,'/',pins) as component,update_time_op from ICT_Project_Test_Realtime.program_fail
                        where program_id='{0}' and board='{1}' and flag=1 and end_time>='{2}'  
                        and test_type='testjet' and fail_state=2  
                        group by component,pins,update_time_op
    ...
    def get(self,headers=None):
        ...
        try:
            ...
            query=''' select component,test_type,fail_state,program_id,b.solution as solution1,c.solution as solution2,
                      ...
                      left join ICT_Project_Test_Realtime.fail_solution c on a.solution_2=c.id
                      left join ICT_Project_Test_Realtime.fail_solution d on a.solution_3=d.id
                      where program_id='{0}' and board='{1}' and flag=1  and end_time>='{2}'  and test_type in ('digital','boundary scan')
    ...
    def get(self,headers=None):
        ...
        try:
            ...
            query=''' select component,test_type,fail_state,program_id,b.solution as solution1,c.solution as solution2,
                      ...
                      left join ICT_Project_Test_Realtime.fail_solution c on a.solution_2=c.id
                      left join ICT_Project_Test_Realtime.fail_solution d on a.solution_3=d.id
                      where program_id='{0}' and board='{1}'  and flag=1  and end_time>='{2}' and test_type in ('analog powered','powercheck')
                      group by component,test_type,fail_state,program_id,solution1,solution2,solution3,update_op,solution_memo
                      order by component  '''.format(programId,board,after_enddate.strftime('%Y-%m-%d'))
